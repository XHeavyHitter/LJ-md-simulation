...
The force calculation method has three versions. ![force_methods_benchmark.png](results/force_methods_benchmark.png) ![force_methods_benchmark_table.png](results/force_methods_benchmark_table.png) The results suggest that version 3 is the fastest at 500 particles, with version 2 being a close second, and a faster method at smaller quantities of particles.
## References
