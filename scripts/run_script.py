...
from plots import energy_vs_time, energy_vs_time_production, temperature_vs_time, rdf_plot, trajectory_animation
...
trajectory_animation(trajectories, system.L_star)
